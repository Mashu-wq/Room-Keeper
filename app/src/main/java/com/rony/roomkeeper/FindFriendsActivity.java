...
public class FindFriendsActivity extends AppCompatActivity {
    ...
    private void SearchFriends(String searchBoxInput)
    {
        ...
        {
            @Override
            protected void onBindViewHolder(@NonNull FindFriendsActivity.FindFriendViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FindFriends model)
            {
