...
//        PostCommentButton = (Button) findViewById(R.id.post_comment_button);
    ...
    private void DisplayAllComments(){
        FirebaseRecyclerOptions<Comments> options=new FirebaseRecyclerOptions.Builder<com.rony.roomkeeper.Comments>().setQuery(CommentRef, com.rony.roomkeeper.Comments.class).build();
        FirebaseRecyclerAdapter<Comments,CommentsViewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<com.rony.roomkeeper.Comments,CommentsViewholder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull CommentsViewholder holder, int position, @NonNull com.rony.roomkeeper.Comments model) {
                try {
